...
export type Product = {
  ...
  // Old Fields (Optional) - Kept to prevent TypeScript errors in ProductCard
...
export const productDb: Product[] = [
...

  {
    ...
    category: { en: 'Micro-Nutrient', bn: 'মাইক্রো-নিউট্রিয়েন্ট' },
    productName: { en: 'AIRN Boric Acid (Boron 17%)', bn: 'এয়ারএন বোরিক এসিড (বোরন ১৭%)' },
    ...
    specs: [
      ...
      {
        title: { en: 'Crops', bn: 'প্রয়োগ ক্ষেত্র' },
  ...
  },
  {
    ...
    categoryId: 'micro-nutrient',
    category: { en: 'Micro-Nutrient', bn: 'মাইক্রো-নিউট্রিয়েন্ট' },
    productName: { en: 'AIRN Solubor Boron (Boron 20%)', bn: 'এয়ারএন সলুবর বোরন (বোরন ২০%)' },
    ...
    specs: [
      ...
      {
        title: { en: 'Benefits', bn: 'ব্যবহারের সুবিধা' },
        details: { en: 'Fully water-soluble. Quickly corrects Boron deficiency, prevents flower and fruit drop, and ensures healthy fruit development.', bn: 'সম্পূর্ণরূপে পানিতে দ্রবণীয়। বোরনের অভাব দ্রুত পূরণ করে, ফুল ও ফল ঝরা রোধ করে এবং ফলের সুষম গঠনে সহায়তা করে।' },
      },
      {
        title: { en: 'Crops', bn: 'প্রয়োগ ক্ষেত্র' },
  ...
  },
  {
    ...
    categoryId: 'micro-nutrient',
    category: { en: 'Micro-Nutrient', bn: 'মাইক্রো-নিউট্রিয়েন্ট' },
    productName: { en: 'AIRN Zinc (Monohydrate)', bn: 'এয়ারএন জিংক (মনোহাইড্রেট)' },
  ...
  },
  {
    ...
    categoryId: 'micro-nutrient',
    category: { en: 'Micro-Nutrient', bn: 'মাইক্রো-নিউট্রিয়েন্ট' },
    productName: { en: 'AIRN Gypsum (Sulphur 17%)', bn: 'এয়ারএন জিপসাম (সালফার ১৭%)' },
  ...
  },
  {
    ...
    categoryId: 'micro-nutrient',
    category: { en: 'Micro-Nutrient', bn: 'মাইক্রো-নিউট্রিয়েন্ট' },
    productName: { en: 'AIRN Magnesium Sulphate', bn: 'এয়ারএন ম্যাগনেসিয়াম সালফেট' },
    image: '/images/product-magnesium.jpg', // New product
    specs: [
      {
        title: { en: 'Ingredients', bn: 'উপাদান' },
        details: { en: 'Magnesium (Mg): 9.6%', bn: 'ম্যাগনেসিয়াম (Mg): ৯.৬%' },
      },
      {
        title: { en: 'Benefits', bn: 'ব্যবহারের সুবিধা' },
  ...
  
  {
    ...
    category: { en: 'Bio-Fungicide', bn: 'বায়ো-ফাঙ্গিসাইড' },
    productName: { en: 'Trirun Bio-Fungicide', bn: 'ট্রাইরুন বায়ো-ফাঙ্গিসাইড' },
    image: '/images/product-trirun.jpeg', // New image
    specs: [
      {
        title: { en: 'Active Ingredient', bn: 'সক্রিয় উপাদান' },
        details: { en: 'Trichoderma Harzianum', bn: 'ট্রাইকোডারমা হারজিয়ানাম' },
      },
      {
        title: { en: 'Benefits', bn: 'ব্যবহারের সুবিধা' },
        details: { en: 'A natural and organic fungicide that protects crops from various soil-borne and seed-borne diseases like root rot, damping-off, and wilt.', bn: 'একটি প্রাকৃতিক ও জৈব ছত্রাকনাশক যা ফসলকে মূল পচা, গোড়া পচা এবং ঢলে পড়া রোগের মতো বিভিন্ন মাটি ও বীজবাহিত রোগ থেকে রক্ষা করে।' },
      },
    ],
  },
  ...
  
  {
    ...
    productName: { en: 'AIRN Jaibo Shar (40 KG)', bn: 'এয়ারএন জৈব সার (৪০ কেজি)' },
    ...
    specs: [
      ...
      {
        title: { en: 'Application Rate', bn: 'প্রয়োগের মাত্রা' },
  ...
  },
  {
    ...
    categoryId: 'organic-fertilizer',
    category: { en: 'Organic Fertilizer', bn: 'জৈব সার' },
    productName: { en: 'AIRN Jaibo Shar (10 KG)', bn: 'এয়ারএন জৈব সার (১০ কেজি)' },
    ...
    specs: [
      ...
      },
      {
        ...
        details: { en: 'Also available in 5 KG and 40 KG sizes.', bn: '৫ কেজি এবং ৪০ কেজি সাইজেও পাওয়া যায়।' },
      },
    ],
  },
  {
    ...
    categoryId: 'organic-fertilizer',
    category: { en: 'Organic Fertilizer', bn: 'জৈব সার' },
    productName: { en: 'AIRN Jaibo Shar (5 KG)', bn: 'এয়ারএন জৈব সার (৫ কেজি)' },
    ...
    specs: [
      ...
      {
        title: { en: 'Note', bn: 'দ্রষ্টব্য' },
        details: { en: 'Also available in 10 KG and 40 KG sizes.', bn: '১০ কেজি এবং ৪০ কেজি সাইজেও পাওয়া যায়।' },
      },
    ],
  },
];
